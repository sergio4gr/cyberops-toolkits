...
WINDOWS_CHISEL64_URL="https://github.com/jpillora/chisel/releases/download/v1.7.7/chisel_1.7.7_windows_amd64.gz"
...
WINDOWS_INVOKEPOWERSHELLTCP_URL="https://raw.githubusercontent.com/samratashok/nishang/master/Shells/Invoke-PowerShellTcp.ps1"
WINDOWS_POWERUP_URL="https://raw.githubusercontent.com/PowerShellMafia/PowerSploit/master/Privesc/PowerUp.ps1"
WINDOWS_SHARPUP_URL="https://github.com/r3motecontrol/Ghostpack-CompiledBinaries/raw/master/SharpUp.exe"
WINDOWS_SEATBELT_URL="https://github.com/r3motecontrol/Ghostpack-CompiledBinaries/raw/master/Seatbelt.exe"
...
LINUX_CHISEL64_URL="https://github.com/jpillora/chisel/releases/download/v1.7.7/chisel_1.7.7_linux_amd64.gz"
...
LINUX_PWNKIT_URL="https://github.com/ly4k/PwnKit/raw/main/PwnKit"
...
curl -s -k -L "$WINDOWS_CHISEL64_URL" -o "/opt/windows_tools/chisel64.gz" >/dev/null && gzip -d "/opt/windows_tools/chisel64.gz" && mv "/opt/windows_tools/chisel64" "/opt/windows_tools/chisel64.exe" && echo "[*] windows_tools -> chisel64.exe" 
...
curl -s -k -L "$WINDOWS_POWERUP_URL" -o "/opt/windows_tools/PowerUp.ps1" >/dev/null && echo "[*] windows_tools -> PowerUp.ps1"
curl -s -k -L "$WINDOWS_INVOKEPOWERSHELLTCP_URL" -o "/opt/windows_tools/Invoke-PowerShellTcp.ps1" >/dev/null && echo "[*] windows_tools -> Invoke-PowerShellTcp.ps1"
curl -s -k -L "$WINDOWS_SHARPUP_URL" -o "/opt/windows_tools/SharpUp.exe" >/dev/null && echo "[*] windows_tools -> SharpUp.exe"
curl -s -k -L "$WINDOWS_SEATBELT_URL" -o "/opt/windows_tools/Seatbelt.exe" >/dev/null && echo "[*] windows_tools -> Seatbelt.exe"
...
curl -s -k -L "$LINUX_CHISEL64_URL" -o "/opt/linux_tools/chisel64.gz" >/dev/null && gzip -d "/opt/linux_tools/chisel64.gz" && echo "[*] linux_tools -> chisel64" 
...
curl -s -k -L "$LINUX_PWNKIT_URL" -o "/opt/linux_tools/pwnkit" >/dev/null && echo "[*] linux_tools -> pwnkit"
